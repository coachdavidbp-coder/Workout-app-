...
const CURATED = [
  ...
  },
  {
    ...
    emoji: "🌯", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Meal-Prep"],
    cal: 560, protein: 45, fat: 20, carbs: 48, time: 25,
    ingredients: ["6 oz sirloin", "1 cup rice", "Black beans", "Pico de gallo", "Corn", "Lime, cilantro"],
    steps: ["Sear and slice the steak.", "Warm beans and rice.", "Build the bowl and top with pico, corn, lime."],
    yt: "steak burrito bowl meal prep",
  },
  {
    ...
    emoji: "🌯", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Quick"],
    cal: 430, protein: 42, fat: 14, carbs: 34, time: 12,
    ingredients: ["6 oz shredded chicken", "2 tbsp buffalo sauce", "Greek yogurt ranch", "Romaine", "Large tortilla"],
    steps: ["Toss chicken in buffalo sauce.", "Layer lettuce and ranch on the tortilla.", "Add chicken, roll tight, slice."],
    yt: "buffalo chicken wrap high protein",
  },
  {
    id: "salmon-rice-bowl",
    ...
    emoji: "🍣", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Post-Workout"],
    cal: 540, protein: 40, fat: 20, carbs: 50, time: 22,
    ingredients: ["6 oz salmon", "1 cup rice", "Edamame", "Cucumber", "Teriyaki, sesame seeds"],
    steps: ["Bake or pan-sear the salmon.", "Glaze with teriyaki.", "Serve over rice with edamame and cucumber."],
    yt: "teriyaki salmon rice bowl recipe",
  },
  {
    id: "turkey-meatballs",
    name: "Turkey Meatballs & Marinara",
    emoji: "🍝", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Batch-Cook", "Meal-Prep"],
    cal: 420, protein: 40, fat: 16, carbs: 28, time: 35,
    ingredients: ["1 lb ground turkey", "1 egg", "¼ cup breadcrumbs", "Garlic, Italian herbs", "Marinara"],
    steps: ["Mix turkey, egg, crumbs and seasoning; roll into balls.", "Bake 20 min at 400°F.", "Simmer in marinara and serve."],
    yt: "healthy turkey meatballs recipe",
  },
  {
    id: "shrimp-tacos",
    ...
    emoji: "🌮", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Quick"],
    cal: 390, protein: 34, fat: 12, carbs: 36, time: 18,
    ingredients: ["8 oz shrimp", "Corn tortillas", "Cabbage slaw", "Greek yogurt crema", "Lime, chili powder"],
    steps: ["Season and sear shrimp 3 min.", "Warm tortillas.", "Fill with shrimp, slaw and crema."],
    yt: "grilled shrimp tacos recipe",
  },
  {
    id: "beef-stirfry-noodles",
    name: "Beef & Veggie Noodle Stir-Fry",
    emoji: "🍜", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Quick"],
    cal: 500, protein: 38, fat: 18, carbs: 46, time: 20,
    ingredients: ["6 oz flank steak", "Rice noodles", "Peppers, snap peas", "Soy, garlic, ginger", "Sesame oil"],
    steps: ["Cook noodles, set aside.", "Sear beef, remove; stir-fry veg.", "Return beef, add noodles and sauce, toss."],
    yt: "beef noodle stir fry recipe",
  },
  {
    id: "protein-french-toast",
    name: "Protein French Toast",
    emoji: "🍞", diet: ["balanced", "high_protein", "vegetarian"],
    tags: ["High-Protein", "Breakfast", "Quick"],
    cal: 380, protein: 32, fat: 10, carbs: 42, time: 12,
    ingredients: ["2 slices whole-grain bread", "2 eggs", "¼ cup egg whites", "Cinnamon, vanilla", "Sugar-free syrup"],
    steps: ["Whisk eggs, whites, cinnamon and vanilla.", "Soak bread, cook 2–3 min per side.", "Top with syrup and berries."],
    yt: "protein french toast recipe",
  },
  {
    id: "breakfast-burrito",
    name: "Meal-Prep Breakfast Burrito",
    emoji: "🌯", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Meal-Prep", "Breakfast"],
    cal: 420, protein: 30, fat: 16, carbs: 38, time: 25,
    ingredients: ["4 eggs", "4 oz turkey sausage", "Peppers & onion", "Cheese", "Large tortillas"],
    steps: ["Scramble eggs with sausage and veg.", "Fill and roll tortillas.", "Wrap in foil — freezes well, reheat 90 sec."],
    yt: "meal prep breakfast burrito recipe",
  },
  {
    id: "cottage-berry-bowl",
    name: "Cottage Cheese Berry Bowl",
    emoji: "🫐", diet: ["balanced", "high_protein", "vegetarian", "glp1", "lower_carb"],
    tags: ["High-Protein", "No-Cook", "Quick"],
    cal: 260, protein: 28, fat: 6, carbs: 22, time: 3,
    ingredients: ["1 cup cottage cheese", "½ cup berries", "1 tbsp almonds", "Cinnamon", "Drizzle of honey"],
    steps: ["Spoon cottage cheese into a bowl.", "Top with berries and almonds.", "Dust with cinnamon and drizzle honey."],
    yt: "cottage cheese breakfast bowl",
  },
  {
    id: "chicken-sweet-potato-hash",
    name: "Chicken & Sweet Potato Hash",
    emoji: "🍠", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "One-Pan", "Meal-Prep"],
    cal: 480, protein: 42, fat: 16, carbs: 42, time: 28,
    ingredients: ["6 oz chicken", "1 sweet potato, cubed", "Bell pepper, onion", "Paprika, garlic", "Olive oil"],
    steps: ["Roast or pan-cook the sweet potato 12 min.", "Add chicken and veg, cook through.", "Season and finish in the pan."],
    yt: "chicken sweet potato hash recipe",
  },
  {
    id: "tuna-pasta-salad",
    name: "High-Protein Tuna Pasta Salad",
    emoji: "🥗", diet: ["balanced", "high_protein"],
    tags: ["High-Protein", "Meal-Prep", "No-Cook"],
    cal: 410, protein: 36, fat: 12, carbs: 40, time: 15,
    ingredients: ["2 pouches tuna", "2 cups cooked pasta", "Greek yogurt", "Celery, red onion", "Lemon, dill"],
    steps: ["Mix yogurt, lemon and dill.", "Fold in tuna, pasta and veg.", "Chill 20 min and serve."],
    yt: "tuna pasta salad healthy recipe",
  },
  {
    id: "protein-rice-krispie",
    name: "Protein Rice Crispy Bars",
    emoji: "🍫", diet: ["balanced", "high_protein", "vegetarian"],
    tags: ["High-Protein", "Snack", "Batch-Cook"],
    cal: 180, protein: 14, fat: 6, carbs: 20, time: 15,
    ingredients: ["2 cups crisp rice cereal", "2 scoops whey", "½ cup peanut butter", "⅓ cup honey", "Pinch of salt"],
    steps: ["Warm peanut butter and honey until smooth.", "Stir in whey, then cereal.", "Press into a pan, chill 1 hr, cut into 8."],
    yt: "protein rice krispie treats recipe",
  },
  {
    id: "greek-chicken-bowl",
    name: "Greek Chicken Bowl",
    emoji: "🥙", diet: ["balanced", "high_protein", "lower_carb"],
    tags: ["High-Protein", "Meal-Prep"],
    cal: 470, protein: 44, fat: 18, carbs: 30, time: 25,
    ingredients: ["6 oz chicken", "Cucumber, tomato, red onion", "Feta", "Tzatziki", "Quinoa or cauli-rice"],
    steps: ["Season chicken with oregano and lemon, grill.", "Chop the salad veg.", "Build over quinoa with feta and tzatziki."],
    yt: "greek chicken bowl meal prep",
  },
  {
    id: "protein-pudding-cup",
    name: "Chocolate Protein Pudding",
    emoji: "🍮", diet: ["balanced", "high_protein", "vegetarian", "glp1"],
    tags: ["High-Protein", "No-Cook", "Snack"],
    cal: 220, protein: 30, fat: 5, carbs: 14, time: 5,
    ingredients: ["1 cup Greek yogurt", "1 scoop chocolate protein", "1 tbsp cocoa", "Splash of milk", "Berries"],
    steps: ["Whisk yogurt, protein and cocoa.", "Thin with milk to pudding texture.", "Chill 15 min, top with berries."],
    yt: "chocolate protein pudding recipe",
  },
];
